...
import javax.swing.*;
class ClientP7 extends Frame implements ActionListener,Runnable
{
	Socket s;
	Label lf;
	TextArea tf,tt;
...
class LoginPageC extends JFrame implements ActionListener
{
	JLabel lid,pw;
	JButton bok,bcl;
	JTextField tid;
